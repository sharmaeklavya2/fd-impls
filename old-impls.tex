...
\begin{observation}[EF$\implies$EFX+EF1]
...
\begin{observation}[PROPm$\implies$PROPx for $n=2$ or chores]
...
\begin{restatable}[MEFS$\implies$PROP]{lemma}{rthm:impl:mefs-to-prop}
