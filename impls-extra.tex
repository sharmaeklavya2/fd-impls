\section{Proofs of Implications Among Fairness Notions}
...
\begin{remark}[EF$\implies$EFX+EF1]
...
\begin{restatable}[EFX$\implies$EF1]{lemma}{rthm:impl:efx-to-ef1}
...
\begin{restatable}[MXS$\implies$EF1 for $n=2$]{lemma}{rthm:impl:mxs-to-ef1-n2}
...
\begin{restatable}[PROPx$\implies$PROPm]{lemma}{rthm:impl:propx-to-propm}
...
\begin{restatable}[PROPm$\implies$PROP1]{lemma}{rthm:impl:propm-to-prop1}
...
\begin{restatable}[MEFS$\implies$PROP, \cite{bouveret2016characterizing}]{lemma}{rthm:impl:mefs-to-prop}
...
\begin{restatable}[EF$\implies$GPROP]{lemma}{rthm:impl:ef-to-gprop}
...
\begin{restatable}[PROP$\implies$EF for idval]{lemma}{rthm:impl:prop-to-ef-superadd-id}
...
\begin{restatable}[PROP$\implies$EF for $n=2$]{lemma}{rthm:impl:prop-to-ef-n2}
...
\begin{lemma}[MXS$\implies$PROP1, Theorem 3 of \cite{caragiannis2023new}]
...
\begin{restatable}[EEF1$\implies$PROP1]{lemma}{rthm:impl:eef1-to-prop1}
...
\begin{restatable}[EEFX$\implies$PROPx]{lemma}{rthm:impl:eefx-to-propx}
...
\begin{restatable}[EFX$\implies$PROPm]{lemma}{rthm:impl:efx-to-propm}
...
\begin{lemma}[MMS$\implies$EFX for $n=2$]
...
\begin{restatable}[MMS$\implies$EEFX, \cite{caragiannis2023new}]{lemma}{rthm:impl:mms-to-eefx}
...
\begin{restatable}[MMS$\implies$MXS]{lemma}{rthm:impl:mms-to-mxs}
...
\begin{lemma}[PROP$\implies$APS, Proposition 4 of \cite{babaioff2023fair}]
...
\begin{restatable}[PROP$\implies$WMMS]{lemma}{rthm:impl:prop-to-wmms}
...
\begin{restatable}[PROP$\implies$pessShare]{lemma}{rthm:impl:prop-to-pessShare}
...
\begin{lemma}[APS$\implies$pessShare]
...
\begin{restatable}[WMMS$\implies$APS for $n=2$]{lemma}{rthm:impl:mms-to-aps-n2}
...
\toprule & \small marginals & \small $n=2$ & \small entitlements & &
\\\midrule EF1 $\fimplies$ EFX & $\{-1, 0, 1\}$
    & -- & -- & -- & trivial
\\[\defaultaddspace] EEF1 $\fimplies$ EEFX & $\{-1, 0, 1\}$
    & -- & -- & -- & trivial
\\[\defaultaddspace] M1S $\fimplies$ MXS & $\{-1, 0, 1\}$
    & -- & -- & -- & trivial
\\[\defaultaddspace] PROP1 $\fimplies$ PROPx & $\{-1, 0, 1\}$
    & -- & -- & -- & trivial
%
\\\midrule PROP $\fimplies$ EEF & $\{-1, 0, 1\}$
    & -- & equal & \cref{thm:impl:tribool:prop} & \textbf{new}
\\[\defaultaddspace] APS $\fimplies$ PROPx & $\{-1, 0, 1\}$
    & -- & -- & \cref{thm:impl:tribool:prop1,thm:impl:tribool:aps} & \textbf{new}
\\[\defaultaddspace] PROP1 $\fimplies$ APS & $\{-1, 0, 1\}$
    & -- & -- & \cref{thm:impl:tribool:prop1,thm:impl:tribool:aps} & \textbf{new}
\\[\defaultaddspace] M1S $\fimplies$ APS & $\{-1, 0, 1\}$
    & -- & equal & \cref{thm:impl:tribool:aps,thm:impl:tribool:m1s} & \textbf{new}
\\[\defaultaddspace] MMS $\fimplies$ EEFX & $\{-1, 0, 1\}$
    & -- & equal & \cref{thm:impl:tribool:mms-to-eefx} & \textbf{new}
%
\\\midrule EF1 $\fimplies$ GAPS & $\{-1, 0, 1\}$
    & -- & equal & \cref{thm:impl:tribool:ef1-gaps} & \textbf{new}
\\[\defaultaddspace] EF1 $\fimplies$ GAPS & $\{-1, 0, 1\}$
    & $n=2$ & -- & \cref{thm:impl:tribool:ef1-gaps} & \textbf{new}
\\[\defaultaddspace] EF1 $\fimplies$ GAPS & $\{-1, 0\}$
