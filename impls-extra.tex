...
\begin{restatable}[EFX $\fimplies$ EF1]{lemma}{rthm:impl:efx-to-ef1}
...
\begin{restatable}[MXS $\fimplies$ EF1 for $n=2$]{lemma}{rthm:impl:mxs-to-ef1-n2}
...
\begin{restatable}[PROPx $\fimplies$ PROPm]{lemma}{rthm:impl:propx-to-propm}
...
\begin{restatable}[PROPm $\fimplies$ PROP1]{lemma}{rthm:impl:propm-to-prop1}
...
\begin{restatable}[MEFS $\fimplies$ PROP, \cite{bouveret2016characterizing}]{lemma}{rthm:impl:mefs-to-prop}
...
\begin{restatable}[EF $\fimplies$ GPROP]{lemma}{rthm:impl:ef-to-gprop}
...
\begin{restatable}[PROP $\fimplies$ EF for idval]{lemma}{rthm:impl:prop-to-ef-superadd-id}
...
\begin{restatable}[PROP $\fimplies$ EF for $n=2$]{lemma}{rthm:impl:prop-to-ef-n2}
...
\begin{restatable}[EEF1 $\fimplies$ PROP1, Proposition 2 of \cite{aziz2021fair}]{lemma}{rthm:impl:eef1-to-prop1}
...
\begin{restatable}[EEFX $\fimplies$ PROPx, Lemma 2.1 of \cite{li2022almost}]{lemma}{rthm:impl:eefx-to-propx}
...
\begin{restatable}[EFX $\fimplies$ PROPm]{lemma}{rthm:impl:efx-to-propm}
...
\begin{restatable}[MMS $\fimplies$ EEFX, \cite{caragiannis2023new}]{lemma}{rthm:impl:mms-to-eefx}
...
\begin{restatable}[MMS $\fimplies$ MXS]{lemma}{rthm:impl:mms-to-mxs}
...
\begin{restatable}[PROP $\fimplies$ WMMS]{lemma}{rthm:impl:prop-to-wmms}
...
\begin{restatable}[PROP $\fimplies$ pessShare]{lemma}{rthm:impl:prop-to-pessShare}
...
\begin{restatable}[WMMS $\fimplies$ APS for $n=2$]{lemma}{rthm:impl:mms-to-aps-n2}
