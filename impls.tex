...
and defer the details and proofs to \cref{sec:impls-extra}.
%
For conciseness in the table, we write ep-$F$ instead of epistemic-$F$,
min-$F$-sh instead of minimum-$F$-share,
g-$F$ instead of groupise-$F$, and p-$F$ instead of pairwise-$F$.
...
EFX $\fimplies$ EF1, EEFX $\fimplies$ EEF1, and MXS $\fimplies$ M1S hold for additional settings.
