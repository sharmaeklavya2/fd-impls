...
and defer the details and proofs to \cref{sec:cex-extra}.
...
\\[\defaultaddspace] APS+PROPx $\nfimplies$ EF1
    & additive & $1$ & yes & $n \ge 3$ & equal & \cref{cex:share-vs-envy-goods} & trivial
\\[\defaultaddspace] APS+EEFX $\nfimplies$ EF1
    & additive & $-1$ & yes & $n \ge 3$ & equal & \cref{cex:share-vs-envy-chores} & trivial
%
\\\midrule EEF $\nfimplies$ EF1
...
\\[\defaultaddspace] MXS $\nfimplies$ PROPx
    & additive & bival & yes & $n=2$ & equal & \cref{cex:mxs-not-propx-n2} & \textbf{new}
\\[\defaultaddspace] M1S $\nfimplies$ PROP1
...
%
\\\midrule EF+APS $\nfimplies$ PROP1
    & supermod & $\ge 0$ bival & yes & $n=2$ & equal & \cref{cex:ef-not-prop-submod} & folklore
\\[\defaultaddspace] PROP $\nfimplies$ M1S
