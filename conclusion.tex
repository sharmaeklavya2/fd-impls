...
From \cref{fig:additive-nny}, we can see that the only notions whose feasibility is unknown are EFX and PMMS,
...
\item For additive goods (equal entitlements), does MXS imply EEF1?
    Note that the implication holds for the special case of two agents (\cref{thm:impl:mxs-to-ef1-n2}).
...
or relations between approximations of fairness notions \cite{amanatidis2018comparing}.
It would be interesting to extend \cref{sec:cpig} for these.
