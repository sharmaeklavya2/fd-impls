...
\begin{lemma}[EF $\fimplies$ GPROP, \cite{bouveret2016characterizing}]
...
Consider a fair division instance $([2], [m], (v_1, v_2), w)$ where $v_1$ is subadditive.
...
\begin{lemma}[APS $\fimplies$ pessShare, \cite{babaioff2023fair}]
...
\begin{lemma}[WMMS $\fimplies$ APS for $n=2$, \cite{babaioff2023fair}]
...
valuations are additive and marginals are binary or negative-binary,
...
Let $([n], [m], (v_i)_{i=1}^n, w)$ be a fair division instance where
