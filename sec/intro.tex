...
%\footnote{Consider dividing a house, a car, and a bicycle among two agents.
%Intuitively, the agent who gets the house shouldn't get anything else,
%but allocating the house and the bicycle to one agent and the car to the other is EF1.},
so a stronger notion called \emph{EFX} (envy-freeness up to any item)
