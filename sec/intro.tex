...
\Cref{sec:settings-extra,sec:notions-extra} contains details on fair division settings and fairness notions.
\Cref{sec:impls-extra,sec:cex-extra} contains proofs of our (non-)implication results.
\Cref{sec:feas} contains results regarding (in)feasibility of fairness notions.
