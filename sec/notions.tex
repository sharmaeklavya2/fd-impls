...
Define conditions C1, C2, C4 as follows:
\begin{tightenum}
...
\item[(C4)]\label{item:propavg}
    $T = \emptyset$, or $v_i(A_i) + \frac{1}{n-1}\sum_{j \in [n] \setminus \{i\}}\tau_j > w_iv_i([m])$.
\end{tightenum}
...
PROPavg was originally defined in \cite{kobayashi2025proportional} for additive goods.
