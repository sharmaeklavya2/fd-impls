...
\begin{figure*}[!htb]
\centering
\includegraphics[scale=0.8]{dags/submod-nonneg-nny.pdf}
\caption{Submodular valuations, goods, equal entitlements.}
\label{fig:submod-nonneg-nny}
\end{figure*}

\begin{figure*}[!htb]
\centering
\includegraphics[scale=0.8]{dags/submod-nonneg-nyy.pdf}
\caption{Submodular valuations, goods, two agents, equal entitlements.}
