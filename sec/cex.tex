...
%
\\\midrule EF+GAPS $\nfimplies$ PROP1
    & supermod & $\ge 0$ bival & yes & $n \ge 2$ & equal & \cref{cex:ef-not-prop-supmod} & folklore
\\[\defaultaddspace] PPROP $\nfimplies$ PROP1
    & supermod & $\ge 0$ bival & yes & $n \ge 3$ & equal & \cref{cex:ef-not-prop-supmod} & folklore
\\[\defaultaddspace] PROP $\nfimplies$ M1S
    & submod & $\ge 0$ bival & yes & $n=2$ & equal & \cref{cex:prop-not-m1s-uniform-matroid} & \textbf{new}
\\[\defaultaddspace] EF $\nfimplies$ MMS
    & submod & $\ge 0$ bival & yes & $n=2$ & equal & \cref{cex:ef-not-mms-pmrf} & folklore
\\[\defaultaddspace] EF1 $\nfimplies$ MXS
    & submod & $\{0, 1\}$ & yes & $n=2$ & equal & \cref{cex:ef1-not-mxs-pmrf} & \textbf{new}
\\[\defaultaddspace] MEFS $\nfimplies$ EF1
    & submod & $\ge 0$ bival & yes & $n=2$ & equal & \cref{cex:mefs-not-ef1-pmrf} & \textbf{new}
\\[\defaultaddspace] EEF $\nfimplies$ EF1 or PPROP
    & submod & $\ge 0$ bival & yes & $n=3$ & equal & \cref{cex:eef-not-ef1-pprop-pmrf} & \textbf{new}
\\[\defaultaddspace] MMS $\nfimplies$ APS
...
\\[\defaultaddspace] GAPS+PPROP $\nfimplies$ PROP1
    & subadd & $\ge 0$ bival & yes & $n=3$ & equal & \cref{cex:gaps-not-prop1-subadd} & \textbf{new}
\\[\defaultaddspace] PAPS+PPROP $\nfimplies$ PROPm
