...
\\ \midrule PROP $\nfimplies$ M1S
    ...
    & \cref{cex:prop-not-m1s-submod} & \textbf{new}
...
$f \defeq \PMRF(P)$ is submodular, and $f(g \mid X) \in \{0, 1\}$
for any $X \subseteq M$ and $g \in M \setminus X$.
\end{lemma}
\begin{proof}[Proof sketch]
$f$ is the rank function of a partition matroid.
% TODO: prove.
\end{proof}
...
and $v(X) \defeq \PMRF(P)(X) + |X|\eps$ for all $X \subseteq M \defeq \{r_1, r_2, g_1, g_2\}$.
Consider a fair division instance with 2 equally-entitled agents
