...
\\[\defaultaddspace] GAPS $\nfimplies$ PROPx
    & unit-dem & $\ge 0$ & yes & $n=3$ & equal & \cref{cex:gaps-not-propx:unit-demand} & \textbf{new}
...
\\[\defaultaddspace] MMS $\nfimplies$ APS
    & submod & $> 0$ & yes & $n=2$ & equal & \cref{cex:mms-not-aps-n2-submod} & known
...
\\[\defaultaddspace] EF1 $\nfimplies$ PROP1
    & subadd & $\{0, 1\}$ & yes & $n=3$ & equal & \cref{cex:ef1-not-prop1-subadd} & \textbf{new}
