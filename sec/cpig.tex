...
We initialize it with a list of implications and counterexamples
(\cref{table:impls1,table:cex-add} from \cref{sec:summary},
\cref{table:impls-tribool,table:impls-unit-demand} from \cref{sec:impls-extra},
and \cref{table:cex-nonadd} from \cref{sec:cex-nonadd-extra}),
