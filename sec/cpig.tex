...
After we proved the results in \cref{table:impls1,table:non-impls},
we wrote a computer program that uses data from these tables
to infer new implications and non-implications among fairness notions.
\Cref{fig:additive-nny,sec:dags} present the program's output for various settings.
