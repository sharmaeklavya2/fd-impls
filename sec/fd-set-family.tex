...
$(\{\mathrm{true},\allowbreak \mathrm{unknown}\},
\{\mathrm{true} \preceq \mathrm{unknown},\allowbreak
\mathrm{true} \preceq \mathrm{true},\allowbreak
\mathrm{unknown} \preceq \mathrm{unknown}\})$.
The partial order for each of the last two features is
represented as a DAG in \cref{fig:dag-posets} in \cref{sec:settings-extra}.
(Formally, for a DAG $G = (V, E)$, the corresponding partial order is $(V, \preceq)$,
...
$s_1 \defeq (\mathrm{unknown},\allowbreak \mathrm{unknown},\allowbreak \mathrm{true},\allowbreak \mathrm{additive},\allowbreak \{1\})$
and $s_2 \defeq (\mathrm{unknown},\allowbreak \mathrm{unknown},\allowbreak \mathrm{unknown},\allowbreak \mathrm{general},\allowbreak \{1\})$
