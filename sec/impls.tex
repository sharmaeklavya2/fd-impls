...
\begin{tightenum}
\item[*] These results hold for additional settings.
    See \cref{thm:impl:efx-to-ef1} in \cref{sec:impls-extra:among-ef-efx-ef1} for details\label{foot:efx-to-ef1}.
