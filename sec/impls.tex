...
\item[\textdagger] \label{foot:pg}In addition to $F_1 \fimplies F_2$, we also get p-$F_1$ $\fimplies$ p-$F_2$
    and g-$F_1$ $\fimplies$ g-$F_2$.
\item[\textdaggerdbl] \label{foot:eef1-to-prop1}\cite{aziz2021fair}
