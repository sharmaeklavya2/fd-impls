...
Let $f: 2^M \to \mathbb{R}$ be submodular function and $S, T \subseteq M$ be disjoint sets.
...
According to \cite{baklanov2021achieving}, when dividing a set $M$ of goods among a set $N$ of agents,
...
(having 3 agents with equal entitlements and identical additive valuations)
