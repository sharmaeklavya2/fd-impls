...
Note that for $S \subseteq A_j$, we require $v_i(S \mid A_j \setminus S) \ge 0$ in \cref{defn:efx},
because otherwise removing $S$ from $A_j$ could increase $i$'s utility for $j$'s bundle,
which would give us a stronger requirement than EF.
...
Our definition of PROP1 (\cref{defn:prop1}) uses strict inequalities, i.e.,
...
However, outside of the identical items case, this nuance doesn't affect our results.
All implications, counterexamples, and (in)feasibility results
