...
We use the definition of PROP1 from \cite{feige2025low}.
...
\begin{definition}[PROPm \cite{baklanov2021achieving} and PROPavg \cite{kobayashi2025proportional}]
...
PROPm was originally defined in \cite{baklanov2021achieving},
and PROPavg was originally defined in \cite{kobayashi2025proportional},
...
PROPavg was first defined in \cite{kobayashi2025proportional} for additive goods,
...
This allocation is PROPx and PROPm, but is not PROPavg by \cite{kobayashi2025proportional}'s definition.

We believe that finding a feasible fairness notion in between PROPx and PROPm is well-motivated,
so we slightly change \cite{kobayashi2025proportional}'s definition to ensure that PROPx implies PROPavg.
