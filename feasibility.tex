...
\\[\defaultaddspace] EEFX & cancelable & $\ge 0$, $\le 0$ & -- & -- & equal
    & \cite{caragiannis2023new,caragiannis2022existence}
...
\item \label{foot:propx-li}Algorithm 2 of \cite{li2022almost} must be slightly modified
    to meet out slightly stricter definition of PROPx.
...
\begin{example}
\label{cex:propx}
Consider an instance with 3 equally-entitled agents having identical additive valuations over 2 goods
...
\\[\defaultaddspace] MMS & additive & $> 0$, $< 0$ & no & $n=3$ & equal
    & \cite{feige2022tight}
\\[\defaultaddspace] PROPx & additive & $> 0$ & yes & $n=3$ & equal
    & \cref{cex:propx}
\\[\defaultaddspace] EFX & additive & $> 0$ & no & $n=2$ & unequal
    & Theorem 8 of \cite{springer2024almost}
\\[\defaultaddspace] EFX & additive & $< 0$ & no & $n=2$ & unequal
    & Theorem 17 of \cite{springer2024almost}
